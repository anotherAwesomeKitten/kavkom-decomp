    ...
    public final class Editor {
            ...
            synchronized (this.this$0) {
                ...
                if (this.entry.getReadable()) {
                    ...
                    if (Intrinsics.areEqual(this.entry.getCurrentEditor(), this) && !this.entry.getZombie()) {
                        try {
                            source = this.this$0.getFileSystem().source(this.entry.getCleanFiles$okhttp().get(i));
        ...
        public final Sink newSink(final int i) {
            synchronized (this.this$0) {
                ...
                try {
                    return new FaultHidingSink(this.this$0.getFileSystem().sink(this.entry.getDirtyFiles$okhttp().get(i)), new Function1<IOException, Unit>() { // from class: okhttp3.internal.cache.DiskLruCache$Editor$newSink$$inlined$synchronized$lambda$1
