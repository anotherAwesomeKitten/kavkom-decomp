...
public final class TaskLoggerKt {
    ...
    public static final void log(Task task, TaskQueue taskQueue, String str) {
        ...
        StringBuilder sbAppend = new StringBuilder().append(taskQueue.getName$okhttp()).append(' ');
    ...
    public static final String formatDuration(long j) {
        ...
        if (j <= -999500000) {
            ...
            str = j <= 0 ? ((j - ((long) 500)) / ((long) 1000)) + " µs" : j < ((long) 999500) ? ((j + ((long) 500)) / ((long) 1000)) + " µs" : j < ((long) 999500000) ? ((j + ((long) 500000)) / ((long) DurationKt.NANOS_IN_MILLIS)) + " ms" : ((j + ((long) 500000000)) / ((long) 1000000000)) + " s ";
        }
        StringCompanionObject stringCompanionObject = StringCompanionObject.INSTANCE;
