...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        if (array != null) {
            try {
                List<X509Certificate> listCheckServerTrusted = this.x509TrustManagerExtensions.checkServerTrusted((X509Certificate[]) array, CipherStorageKeystoreRsaEcb.ALGORITHM_RSA, hostname);
