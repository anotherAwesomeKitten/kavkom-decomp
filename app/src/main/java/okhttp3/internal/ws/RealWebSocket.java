...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final void connect(OkHttpClient client) {
        ...
        realCall.enqueue(new Callback() { // from class: okhttp3.internal.ws.RealWebSocket.connect.1
            ...
            public void onResponse(Call call, okhttp3.Response response) throws Throwable {
    ...
    public final void checkUpgradeSuccess$okhttp(okhttp3.Response response, Exchange exchange) throws IOException {
        ...
        String strHeader$default = okhttp3.Response.header$default(response, HttpHeaders.CONNECTION, null, 2, null);
        ...
        String strHeader$default2 = okhttp3.Response.header$default(response, HttpHeaders.UPGRADE, null, 2, null);
        ...
        String strHeader$default3 = okhttp3.Response.header$default(response, HttpHeaders.SEC_WEBSOCKET_ACCEPT, null, 2, null);
