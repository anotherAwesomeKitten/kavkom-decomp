...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    /* JADX INFO: renamed from: com.facebook.imagepipeline.producers.PartialDiskCacheProducer$1 */
    class AnonymousClass1 implements Continuation<EncodedImage, Void> {
        final /* synthetic */ Consumer val$consumer;
        final /* synthetic */ ProducerListener2 val$listener;
        final /* synthetic */ CacheKey val$partialImageCacheKey;
        final /* synthetic */ ProducerContext val$producerContext;

        AnonymousClass1(ProducerListener2 producerListener2, ProducerContext producerContext, Consumer consumer, CacheKey cacheKey) {
        ...
        public Void then(Task<EncodedImage> task) throws Exception {
            if (PartialDiskCacheProducer.isTaskCancelled(task)) {
                producerListener2.onProducerFinishWithCancellation(producerContext, PartialDiskCacheProducer.PRODUCER_NAME, null);
                consumer.onCancellation();
            } else if (task.isFaulted()) {
                producerListener2.onProducerFinishWithFailure(producerContext, PartialDiskCacheProducer.PRODUCER_NAME, task.getError(), null);
                PartialDiskCacheProducer.this.startInputProducer(consumer, producerContext, cacheKey, null);
            } else {
                EncodedImage result = task.getResult();
                if (result != null) {
                    ProducerListener2 producerListener2 = producerListener2;
                    ...
                    if (max.contains(imageRequest.getBytesRange())) {
                        ...
                        producerListener2.onUltimateProducerReached(producerContext, PartialDiskCacheProducer.PRODUCER_NAME, true);
    ...
    private Continuation<EncodedImage, Void> onFinishDiskReads(Consumer<EncodedImage> consumer, ProducerContext producerContext, CacheKey cacheKey) {
        return new Continuation<EncodedImage, Void>() { // from class: com.facebook.imagepipeline.producers.PartialDiskCacheProducer.1
            ...
            AnonymousClass1(ProducerListener2 producerListener2, ProducerContext producerContext2, Consumer consumer2, CacheKey cacheKey2) {
                producerListener2 = producerListener2;
            ...
            public Void then(Task<EncodedImage> task) throws Exception {
                if (PartialDiskCacheProducer.isTaskCancelled(task)) {
                    ...
                    if (result != null) {
                        ...
                        ProducerListener2 producerListener22 = producerListener2;
                        ProducerContext producerContext22 = producerContext;
                        producerListener22.onProducerFinishWithSuccess(producerContext22, PartialDiskCacheProducer.PRODUCER_NAME, PartialDiskCacheProducer.getExtraMap(producerListener22, producerContext22, false, 0));
                        PartialDiskCacheProducer.this.startInputProducer(consumer, producerContext, cacheKey, result);
                    }
                }
                return null;
    ...
    /* JADX INFO: renamed from: com.facebook.imagepipeline.producers.PartialDiskCacheProducer$2 */
    ...
    private static class PartialDiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        /* synthetic */ PartialDiskCacheConsumer(Consumer consumer, Supplier supplier, CacheKey cacheKey, PooledByteBufferFactory pooledByteBufferFactory, ByteArrayPool byteArrayPool, EncodedImage encodedImage, boolean z, PartialDiskCacheProducerIA partialDiskCacheProducerIA) {
            this(consumer, supplier, cacheKey, pooledByteBufferFactory, byteArrayPool, encodedImage, z);
        }
