...
public class NativeGCMCipherOutputStream extends OutputStream {
    ...
    public void write(byte[] bArr, int i, int i2) throws IOException {
        ...
        while (i8 < i5) {
            byte[] bArr2 = bArr;
            this.mCipherDelegate.write(this.mUpdateBuffer, 0, this.mCipher.update(bArr2, i7, this.mUpdateBufferChunkSize, this.mUpdateBuffer, 0));
        ...
        byte[] bArr3 = bArr;
        if (i6 > 0) {
            this.mCipherDelegate.write(this.mUpdateBuffer, 0, this.mCipher.update(bArr3, i7, i6, this.mUpdateBuffer, 0));
        }
    }
