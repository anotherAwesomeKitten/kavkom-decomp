...
public interface ReactHost {
    ...
    TaskInterface<Void> destroy(String str, Exception ex);

    TaskInterface<Void> destroy(String str, Exception ex, Function1<? super Boolean, Unit> onDestroyFinished);
