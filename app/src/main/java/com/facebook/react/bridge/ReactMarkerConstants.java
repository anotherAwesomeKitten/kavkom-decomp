...
public final class ReactMarkerConstants extends Enum<ReactMarkerConstants> {
    ...
    public static final ReactMarkerConstants FABRIC_LAYOUT_START = new ReactMarkerConstants("FABRIC_LAYOUT_START", InCallManagerModule.myToneGenerator.CALLEND, false, 1, null);
    public static final ReactMarkerConstants FABRIC_LAYOUT_END = new ReactMarkerConstants("FABRIC_LAYOUT_END", 104, false, 1, null);
    public static final ReactMarkerConstants FABRIC_LAYOUT_AFFECTED_NODES = new ReactMarkerConstants("FABRIC_LAYOUT_AFFECTED_NODES", InCallManagerModule.myToneGenerator.RINGBACK, false, 1, null);
    public static final ReactMarkerConstants FABRIC_BATCH_EXECUTION_START = new ReactMarkerConstants("FABRIC_BATCH_EXECUTION_START", InCallManagerModule.myToneGenerator.SILENT, false, 1, null);
