...
public final class PropsAnimatedNode extends AnimatedNode {
    ...
    public final View getConnectedView() {
        ...
        try {
            ...
            UIManager uIManager = this.connectedViewUIManager;
            objM946constructorimpl = Result.m946constructorimpl(uIManager != null ? uIManager.resolveView(this.connectedViewTag) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM946constructorimpl = Result.m946constructorimpl(ResultKt.createFailure(th));
        }
        return (View) (Result.m952isFailureimpl(objM946constructorimpl) ? null : objM946constructorimpl);
    }
