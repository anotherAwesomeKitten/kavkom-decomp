...
public class NativeViewHierarchyManager {
    ...
    @Deprecated
    public void updateLayout(int i, int i2, int i3, int i4, int i5) throws Throwable {
        updateLayout(i, i, i2, i3, i4, i5, YogaDirection.INHERIT);
    }

    public synchronized void updateLayout(int i, int i2, int i3, int i4, int i5, int i6, YogaDirection yogaDirection) throws Throwable {
        Throwable th;
        Throwable th2;
        try {
            try {
    ...
    public synchronized void measure(int i, int[] iArr) {
        ...
        View view = this.mTagsToViews.get(i);
        if (view == null) {
            throw new IllegalViewOperationException("No native view for " + i + " currently exists");
        }
        View view2 = (View) RootViewUtil.getRootView(view);
        if (view2 == null) {
            throw new IllegalViewOperationException("Native view " + i + " is no longer on screen");
        }
