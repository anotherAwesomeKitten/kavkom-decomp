...
public final class ReactSurfaceView extends ReactRootView {
    ...
    protected void dispatchJSTouchEvent(MotionEvent motionEvent) {
        ...
        if (eventDispatcher$ReactAndroid_release != null) {
            JSTouchDispatcher jSTouchDispatcher = this.jsTouchDispatcher;
            ReactHostImpl reactHost$ReactAndroid_release = this.surface.getReactHost$ReactAndroid_release();
            jSTouchDispatcher.handleTouchEvent(motionEvent, eventDispatcher$ReactAndroid_release, reactHost$ReactAndroid_release != null ? reactHost$ReactAndroid_release.getCurrentReactContext() : null);
            return;
        }
    ...
    @Override // com.facebook.react.ReactRootView
    protected void dispatchJSPointerEvent(MotionEvent motionEvent, boolean isCapture) {
        Intrinsics.checkNotNullParameter(motionEvent, "event");
        ...
        if (eventDispatcher$ReactAndroid_release != null) {
            JSPointerDispatcher jSPointerDispatcher = this.jsPointerDispatcher;
            if (jSPointerDispatcher != null) {
                jSPointerDispatcher.handleMotionEvent(motionEvent, eventDispatcher$ReactAndroid_release, isCapture);
                return;
            }
            return;
        }
