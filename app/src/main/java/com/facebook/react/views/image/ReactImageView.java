    ...
    private final class TilePostprocessor extends BasePostprocessor {
        ...
        public CloseableReference<Bitmap> process(Bitmap source, PlatformBitmapFactory bitmapFactory) {
            ...
            try {
                ...
                CloseableReference<Bitmap> closeableReferenceMo168clone = closeableReferenceCreateBitmap.mo168clone();
                Intrinsics.checkNotNullExpressionValue(closeableReferenceMo168clone, "clone(...)");
                return closeableReferenceMo168clone;
            } finally {
