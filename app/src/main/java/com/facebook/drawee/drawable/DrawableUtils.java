...
public final class DrawableUtils {
    ...
    @JvmStatic
    public static final void copyProperties(Drawable to, Drawable drawable) {
        if (drawable == null || to == null || to == drawable) {
            return;
        }
        to.setBounds(drawable.getBounds());
        to.setChangingConfigurations(drawable.getChangingConfigurations());
        to.setLevel(drawable.getLevel());
        to.setVisible(drawable.isVisible(), false);
        to.setState(drawable.getState());
    }
