...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    public static <I, O> Future<O> lazyTransform(Future<I> future, Function<? super I, ? extends O> function) {
        ...
        return new Future<O>() { // from class: com.google.common.util.concurrent.Futures.2
            ...
            AnonymousClass2(Future future2, Function function2) {
                future = future2;
                function = function2;
            }
    ...
    /* JADX INFO: renamed from: com.google.common.util.concurrent.Futures$2 */
    ...
    public static final class FutureCombiner<V> {
        ...
        class AnonymousClass1 implements Callable<Void> {
            ...
            AnonymousClass1(FutureCombiner futureCombiner, Runnable runnable) {
                runnable = runnable;
            }
        ...
        public ListenableFuture<?> run(Runnable runnable, Executor executor) {
            return call(new Callable<Void>(this) { // from class: com.google.common.util.concurrent.Futures.FutureCombiner.1
                ...
                AnonymousClass1(FutureCombiner this, Runnable runnable2) {
                    runnable = runnable2;
                }
    ...
    public static <T> ImmutableList<ListenableFuture<T>> inCompletionOrder(Iterable<? extends ListenableFuture<? extends T>> iterable) {
        ...
        for (int i2 = 0; i2 < listenableFutureArrGwtCompatibleToArray.length; i2++) {
            listenableFutureArrGwtCompatibleToArray[i2].addListener(new Runnable() { // from class: com.google.common.util.concurrent.Futures.3
                ...
                AnonymousClass3(ImmutableList immutableListBuild2, int i22) {
        ...
        return immutableListBuild2;
    }

    /* JADX INFO: renamed from: com.google.common.util.concurrent.Futures$3 */
