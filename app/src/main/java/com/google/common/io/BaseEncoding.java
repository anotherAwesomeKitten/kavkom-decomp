...
public abstract class BaseEncoding {
    ...
    class AnonymousClass1 extends ByteSink {
        ...
        AnonymousClass1(CharSink charSink) {
            charSink = charSink;
        }
    ...
    public final ByteSink encodingSink(CharSink charSink) {
        ...
        return new ByteSink() { // from class: com.google.common.io.BaseEncoding.1
            ...
            AnonymousClass1(CharSink charSink2) {
                charSink = charSink2;
            }
    ...
    class AnonymousClass2 extends ByteSource {
        ...
        AnonymousClass2(CharSource charSource) {
    ...
    public final ByteSource decodingSource(CharSource charSource) {
        ...
        return new ByteSource() { // from class: com.google.common.io.BaseEncoding.2
            ...
            AnonymousClass2(CharSource charSource2) {
                charSource = charSource2;
            }
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        public OutputStream encodingStream(Writer writer) {
            ...
            return new OutputStream() { // from class: com.google.common.io.BaseEncoding.StandardBaseEncoding.1
                ...
                AnonymousClass1(Writer writer2) {
                    writer = writer2;
                }
    ...
    static Appendable separatingAppendable(Appendable appendable, String str, int i) {
        ...
        return new Appendable(i, appendable, str) { // from class: com.google.common.io.BaseEncoding.4
            ...
            AnonymousClass4(int i2, Appendable appendable2, String str2) {
                this.val$afterEveryChars = i2;
                this.val$delegate = appendable2;
                this.val$separator = str2;
    ...
    static Writer separatingWriter(Writer writer, String str, int i) {
        return new Writer() { // from class: com.google.common.io.BaseEncoding.5
            ...
            AnonymousClass5(Appendable appendable, Writer writer2) {
                appendable = appendable;
                writer = writer2;
            }
            ...
            @Override // java.io.Writer
            public void write(char[] cArr, int i2, int i22) throws IOException {
                throw new UnsupportedOperationException();
            }
