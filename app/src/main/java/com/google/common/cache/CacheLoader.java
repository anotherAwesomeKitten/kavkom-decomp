...
public abstract class CacheLoader<K, V> {
        ...
        return new CacheLoader<K, V>() { // from class: com.google.common.cache.CacheLoader.1
            ...
            public ListenableFuture<V> reload(K k, V v) throws Exception {
                ListenableFutureTask listenableFutureTaskCreate = ListenableFutureTask.create(new Callable<V>() { // from class: com.google.common.cache.CacheLoader.1.1
                    ...
                    CallableC00201(Object k2, Object v2) {
                        obj = k2;
                        obj = v2;
                    }
                    ...
                    public V call() throws Exception {
                        return CacheLoader.this.reload(obj, obj).get();
                    }
                });
            ...
            /* JADX INFO: renamed from: com.google.common.cache.CacheLoader$1$1 */
            class CallableC00201 implements Callable<V> {
                final /* synthetic */ Object val$key;
                final /* synthetic */ Object val$oldValue;
    ...
    class AnonymousClass1 extends CacheLoader<K, V> {
        ...
        @Override // com.google.common.cache.CacheLoader
        public ListenableFuture<V> reload(Object k2, Object v2) throws Exception {
            ListenableFutureTask listenableFutureTaskCreate = ListenableFutureTask.create(new Callable<V>() { // from class: com.google.common.cache.CacheLoader.1.1
                final /* synthetic */ Object val$key;
                final /* synthetic */ Object val$oldValue;

                CallableC00201(Object k22, Object v22) {
                    obj = k22;
                    obj = v22;
                }
