...
public final class Maps {
    ...
    class AnonymousClass3<K, V> extends TransformedIterator<K, Map.Entry<K, V>> {
        ...
        AnonymousClass3(Iterator it, Function function) {
            super(it);
            function = function;
        }
    ...
    static <K, V> Iterator<Map.Entry<K, V>> asMapEntryIterator(Set<K> set, Function<? super K, V> function) {
        return new TransformedIterator<K, Map.Entry<K, V>>(set.iterator()) { // from class: com.google.common.collect.Maps.3
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass3(Iterator it, Function function2) {
                super(it);
                function = function2;
            }
    ...
    class AnonymousClass5<E> extends ForwardingSortedSet<E> {
        ...
        AnonymousClass5(SortedSet sortedSet) {
            sortedSet = sortedSet;
        }
    ...
    public static <E> SortedSet<E> removeOnlySortedSet(SortedSet<E> sortedSet) {
        return new ForwardingSortedSet<E>() { // from class: com.google.common.collect.Maps.5
            ...
            AnonymousClass5(SortedSet sortedSet2) {
    ...
    class AnonymousClass6<E> extends ForwardingNavigableSet<E> {
        ...
        AnonymousClass6(NavigableSet navigableSet) {
    ...
    public static <E> NavigableSet<E> removeOnlyNavigableSet(NavigableSet<E> navigableSet) {
        return new ForwardingNavigableSet<E>() { // from class: com.google.common.collect.Maps.6
            ...
            AnonymousClass6(NavigableSet navigableSet2) {
    ...
    class AnonymousClass10<V1, V2> implements Function<V1, V2> {
        ...
        public V2 apply(@ParametricNullness V1 v1) {
            return (V2) entryTransformer.transformEntry(obj, v1);
        }
    }
    ...
    static <V2, K, V1> Map.Entry<K, V2> transformEntry(EntryTransformer<? super K, ? super V1, V2> entryTransformer, Map.Entry<K, V1> entry) {
        ...
        return new AbstractMapEntry<K, V2>() { // from class: com.google.common.collect.Maps.12
            ...
            AnonymousClass12(Map.Entry entry2, EntryTransformer entryTransformer2) {
                entry = entry2;
                entryTransformer = entryTransformer2;
            }
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V> {
        ...
        private class EntrySet extends ForwardingSet<Map.Entry<K, V>> {
            ...
            class AnonymousClass1 extends TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>> {
                ...
                class C00221 extends ForwardingMapEntry<K, V> {
                    final /* synthetic */ Map.Entry val$entry;

                    C00221(Map.Entry entry) {
                        entry = entry;
                    }
            ...
            public Iterator<Map.Entry<K, V>> iterator() {
                return new TransformedIterator<Map.Entry<K, V>, Map.Entry<K, V>>(FilteredEntryMap.this.filteredEntrySet.iterator()) { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1
                    ...
                    @Override // com.google.common.collect.TransformedIterator
                    public Map.Entry<K, V> transform(Map.Entry entry2) {
                        return new ForwardingMapEntry<K, V>() { // from class: com.google.common.collect.Maps.FilteredEntryMap.EntrySet.1.1
                            final /* synthetic */ Map.Entry val$entry;

                            C00221(Map.Entry entry22) {
                                entry = entry22;
                            }
