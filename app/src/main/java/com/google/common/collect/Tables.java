...
public final class Tables {
    ...
    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Tables$TransposeTable$1 */
        class AnonymousClass1 implements Function<Table.Cell<?, ?, ?>, Table.Cell<?, ?, ?>> {
            AnonymousClass1() {
            }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class AnonymousClass2 implements Function<Map<C, V1>, Map<C, V2>> {
            AnonymousClass2() {
            }
        ...
        class AnonymousClass3 implements Function<Map<R, V1>, Map<R, V2>> {
            AnonymousClass3() {
            }
    ...
    /* JADX INFO: renamed from: com.google.common.collect.Tables$1 */
    class AnonymousClass1 implements Function<Map<Object, Object>, Map<Object, Object>> {
        AnonymousClass1() {
        }
