...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    public static <E> FluentIterable<E> from(Iterable<E> iterable) {
        ...
        return new FluentIterable<E>(iterable) { // from class: com.google.common.collect.FluentIterable.1
            ...
            AnonymousClass1(Iterable iterable2, Iterable iterable22) {
                super(iterable22);
                iterable = iterable22;
            }
    ...
    class AnonymousClass1 extends FluentIterable<E> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(Iterable iterable22, Iterable iterable222) {
            super(iterable222);
            iterable = iterable222;
        }
    ...
    private static <T> FluentIterable<T> concatNoDefensiveCopy(Iterable<? extends T>... iterableArr) {
        ...
        return new FluentIterable<T>() { // from class: com.google.common.collect.FluentIterable.3
            ...
            AnonymousClass3(Iterable[] iterableArr2) {
                iterableArr = iterableArr2;
            }
