...
public final class Multimaps {
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> mapUnmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new Function<Collection<V>, Collection<V>>(this) { // from class: com.google.common.collect.Multimaps.UnmodifiableMultimap.1
                AnonymousClass1(UnmodifiableMultimap this) {
                }
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Multimaps$UnmodifiableMultimap$1 */
        class AnonymousClass1 implements Function<Collection<V>, Collection<V>> {
            AnonymousClass1(UnmodifiableMultimap this) {
            }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        class AnonymousClass1 extends Sets.ImprovedAbstractSet<V> {
            ...
            class C00241 implements Iterator<V> {
                int i;
                ...
                public boolean hasNext() {
                    return this.i == 0 && MapMultimap.this.map.containsKey(obj);
                }
                ...
                public V next() {
                    ...
                    this.i++;
                    return (V) NullnessCasts.uncheckedCastNullableTToT(MapMultimap.this.map.get(obj));
                }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        /* JADX INFO: renamed from: com.google.common.collect.Multimaps$TransformedEntriesMultimap$1 */
        class AnonymousClass1 implements Maps.EntryTransformer<K, Collection<V1>, Collection<V2>> {
            AnonymousClass1() {
            }
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        class AnonymousClass1 extends TransformedIterator<Map.Entry<K, Collection<V>>, Multiset.Entry<K>> {
            AnonymousClass1(Keys keys, Iterator it) {
                super(it);
            }

            /* JADX INFO: renamed from: com.google.common.collect.Multimaps$Keys$1$1 */
            class C00231 extends Multisets.AbstractEntry<K> {
                final /* synthetic */ Map.Entry val$backingEntry;

                C00231(AnonymousClass1 anonymousClass1, Map.Entry entry) {
                    entry = entry;
                }
            ...
            public Multiset.Entry<K> transform(Map.Entry<K, Collection<V>> entry) {
                return new Multisets.AbstractEntry<K>(this) { // from class: com.google.common.collect.Multimaps.Keys.1.1
                    ...
                    C00231(AnonymousClass1 this, Map.Entry entry2) {
                        entry = entry2;
                    }
        ...
        Iterator<Multiset.Entry<K>> entryIterator() {
            return new TransformedIterator<Map.Entry<K, Collection<V>>, Multiset.Entry<K>>(this, this.multimap.asMap().entrySet().iterator()) { // from class: com.google.common.collect.Multimaps.Keys.1
                AnonymousClass1(Keys this, Iterator it) {
                    super(it);
                }
                ...
                @Override // com.google.common.collect.TransformedIterator
                public Multiset.Entry<K> transform(Map.Entry entry2) {
                    return new Multisets.AbstractEntry<K>(this) { // from class: com.google.common.collect.Multimaps.Keys.1.1
                        final /* synthetic */ Map.Entry val$backingEntry;

                        C00231(AnonymousClass1 this, Map.Entry entry22) {
                            entry = entry22;
                        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            /* JADX INFO: renamed from: com.google.common.collect.Multimaps$AsMap$EntrySet$1 */
            class AnonymousClass1 implements Function<K, Collection<V>> {
                AnonymousClass1() {
                }
