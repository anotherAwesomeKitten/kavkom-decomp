...
public final class Iterators {
    ...
    class AnonymousClass3<I> extends UnmodifiableIterator<I> {
        ...
        public Iterator next() {
            ...
            Iterator it = (Iterator) java.util.Objects.requireNonNull(itArr[this.index]);
    ...
    private static <I extends Iterator<?>> Iterator<I> consumingForArray(I... iArr) {
        return new UnmodifiableIterator<I>() { // from class: com.google.common.collect.Iterators.3
            ...
            AnonymousClass3(Iterator[] iArr2) {
                itArr = iArr2;
            }
    ...
    private static <T> UnmodifiableIterator<List<T>> partitionImpl(Iterator<T> it, int i, boolean z) {
        ...
        return new UnmodifiableIterator<List<T>>() { // from class: com.google.common.collect.Iterators.4
            ...
            AnonymousClass4(Iterator it2, int i2, boolean z2) {
                it = it2;
                i = i2;
                z = z2;
            }
    ...
    public static <T> UnmodifiableIterator<T> filter(Iterator<T> it, Predicate<? super T> predicate) {
        ...
        return new AbstractIterator<T>() { // from class: com.google.common.collect.Iterators.5
            ...
            AnonymousClass5(Iterator it2, Predicate predicate2) {
                it = it2;
    ...
    class AnonymousClass6<F, T> extends TransformedIterator<F, T> {
        ...
        AnonymousClass6(Iterator it, Function function) {
            super(it);
            function = function;
        }
    ...
    public static <F, T> Iterator<T> transform(Iterator<F> it, Function<? super F, ? extends T> function) {
        ...
        return new TransformedIterator<F, T>(it) { // from class: com.google.common.collect.Iterators.6
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            AnonymousClass6(Iterator it2, Function function2) {
                super(it2);
                function = function2;
            }
    ...
    public static <T> Iterator<T> limit(Iterator<T> it, int i) {
        ...
        return new Iterator<T>() { // from class: com.google.common.collect.Iterators.7
            ...
            AnonymousClass7(int i2, Iterator it2) {
                i = i2;
                it = it2;
            }
