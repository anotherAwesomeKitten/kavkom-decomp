...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    /* synthetic */ Void m636x734756b4() throws Exception {
        synchronized (this) {
    ...
    /* synthetic */ String m635x341e14f2() throws Exception {
        String string;
        synchronized (this) {
