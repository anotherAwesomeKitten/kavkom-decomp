...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    public final void zaI(int i) {
        ...
        googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 9, apiKey), MetricsHelper.FLUSHER_SLEEP_TIME_MS);
    ...
    private final boolean zaM(zai zaiVar) {
        ...
        if (iIndexOf >= 0) {
            ...
            GoogleApiManager googleApiManager = this.zaa;
            googleApiManager.zar.sendMessageDelayed(Message.obtain(googleApiManager.zar, 15, zabsVar2), MetricsHelper.FLUSHER_SLEEP_TIME_MS);
            return false;
        }
        this.zak.add(zabsVar);
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 15, zabsVar), MetricsHelper.FLUSHER_SLEEP_TIME_MS);
    ...
    public final void zar(ConnectionResult connectionResult, Exception exc) {
        ...
        GoogleApiManager googleApiManager2 = this.zaa;
        googleApiManager2.zar.sendMessageDelayed(Message.obtain(googleApiManager2.zar, 9, this.zad), MetricsHelper.FLUSHER_SLEEP_TIME_MS);
    }
