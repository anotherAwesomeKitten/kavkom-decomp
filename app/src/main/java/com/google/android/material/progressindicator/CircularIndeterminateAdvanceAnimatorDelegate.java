...
final class CircularIndeterminateAdvanceAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    class AnonymousClass3 extends Property<CircularIndeterminateAdvanceAnimatorDelegate, Float> {
        AnonymousClass3(Class cls, String str) {
            super(cls, str);
        }
    ...
    class AnonymousClass4 extends Property<CircularIndeterminateAdvanceAnimatorDelegate, Float> {
        AnonymousClass4(Class cls, String str) {
            super(cls, str);
        }
