...
class SearchViewAnimationHelper {
    ...
    private Animator getRootViewAnimator(boolean z) {
        ...
        valueAnimatorOfObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.SearchViewAnimationHelper$$ExternalSyntheticLambda1
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m582xa183b80f(cornerSize, fArrMaxCornerRadii, rect, valueAnimator);
            }
        });
    ...
    /* synthetic */ void m582xa183b80f(float f, float[] fArr, Rect rect, ValueAnimator valueAnimator) {
    ...
    private void addEditTextClipAnimator(AnimatorSet animatorSet) {
        ...
        valueAnimatorOfInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.SearchViewAnimationHelper$$ExternalSyntheticLambda0
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m580xc2294c40(rect, valueAnimator);
            }
        });
        animatorSet.playTogether(valueAnimatorOfInt);
    }

    /* JADX INFO: renamed from: lambda$addEditTextClipAnimator$6$com-google-android-material-search-SearchViewAnimationHelper */
    /* synthetic */ void m580xc2294c40(Rect rect, ValueAnimator valueAnimator) {
    ...
    private void addTextFadeAnimatorIfNeeded(AnimatorSet animatorSet) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.search.SearchViewAnimationHelper$$ExternalSyntheticLambda5
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m581xbfb6df0b(valueAnimator);
            }
        });
        animatorSet.playTogether(valueAnimatorOfFloat);
    }

    /* JADX INFO: renamed from: lambda$addTextFadeAnimatorIfNeeded$7$com-google-android-material-search-SearchViewAnimationHelper */
    /* synthetic */ void m581xbfb6df0b(ValueAnimator valueAnimator) {
