...
final class LinearDrawingDelegate extends DrawingDelegate<LinearProgressIndicatorSpec> {
    ...
    void drawStopIndicator(Canvas canvas, Paint paint, int i, int i2) {
        ...
        drawRoundedBlock(canvas, paint, new DrawingDelegate.PathPoint(new float[]{(this.trackLength / 2.0f) - fFloatValue, 0.0f}, new float[]{1.0f, 0.0f}), ((LinearProgressIndicatorSpec) this.spec).trackStopIndicatorSize, ((LinearProgressIndicatorSpec) this.spec).trackStopIndicatorSize, (this.displayedCornerRadius * ((LinearProgressIndicatorSpec) this.spec).trackStopIndicatorSize) / this.displayedTrackThickness);
    }
