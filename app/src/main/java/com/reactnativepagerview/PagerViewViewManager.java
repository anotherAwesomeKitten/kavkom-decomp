...
public final class PagerViewViewManager extends ViewGroupManager<NestedScrollableHost> implements RNCViewPagerManagerInterface<NestedScrollableHost> {
    ...
    public NestedScrollableHost createViewInstance(final ThemedReactContext reactContext) {
        ...
        viewPager2.post(new Runnable() { // from class: com.reactnativepagerview.PagerViewViewManager$$ExternalSyntheticLambda0
            ...
            public final void run() {
                PagerViewViewManager.createViewInstance$lambda$0(viewPager2, reactContext, nestedScrollableHost);
            }
        });
    ...
    public void setLayoutDirection(NestedScrollableHost view, String value) throws ClassNotFoundException {
    ...
    public void setInitialPage(NestedScrollableHost view, int value) throws ClassNotFoundException {
        if (view != null) {
    ...
    public void setPageMargin(NestedScrollableHost view, int value) throws ClassNotFoundException {
        if (view != null) {
    ...
    public final void goTo(NestedScrollableHost root, int selectedPage, boolean scrollWithAnimation) throws ClassNotFoundException {
        if (root == null) {
            return;
        }
    ...
    @Override // com.facebook.react.viewmanagers.RNCViewPagerManagerInterface
    public void setPage(NestedScrollableHost view, int selectedPage) throws ClassNotFoundException {
        goTo(view, selectedPage, true);
    }

    @Override // com.facebook.react.viewmanagers.RNCViewPagerManagerInterface
    public void setPageWithoutAnimation(NestedScrollableHost view, int selectedPage) throws ClassNotFoundException {
