...
public final class ScreenModalFragment extends BottomSheetDialogFragment implements ScreenStackFragmentWrapper {
    ...
    private final void configureBehaviour() {
        ...
        if (count$react_native_screens_release == 1) {
            ...
            behavior2.setMaxHeight(getScreen().getSheetDetents().maxAllowedHeight$react_native_screens_release(numTryResolveContainerHeight.intValue()));
            return;
        }
        if (count$react_native_screens_release == 2) {
            ...
            behavior3.setPeekHeight(getScreen().getSheetDetents().peekHeight$react_native_screens_release(numTryResolveContainerHeight.intValue()));
            behavior3.setMaxHeight(getScreen().getSheetDetents().maxAllowedHeight$react_native_screens_release(numTryResolveContainerHeight.intValue()));
            return;
        }
        if (count$react_native_screens_release == 3) {
            ...
            behavior4.setPeekHeight(getScreen().getSheetDetents().peekHeight$react_native_screens_release(numTryResolveContainerHeight.intValue()));
            behavior4.setExpandedOffset(SheetDetents.expandedOffsetFromTop$react_native_screens_release$default(getScreen().getSheetDetents(), numTryResolveContainerHeight.intValue(), 0, 2, null));
