...
public final class ScreenFooter extends ReactViewGroup {
    ...
    protected void onLayout(boolean changed, int left, int top, int i, int i2) {
        super.onLayout(changed, left, top, i, i2);
        if (getHasReceivedInitialLayoutFromParent()) {
            layoutFooterOnYAxis(this.lastContainerHeight, i2 - top, sheetTopInStableState(requireSheetBehavior().getState()), this.lastBottomInset);
        }
    }
    ...
    public final void onParentLayout(boolean changed, int left, int top, int i, int i2, int containerHeight) {
