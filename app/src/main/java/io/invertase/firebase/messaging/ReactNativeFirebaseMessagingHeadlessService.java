...
public class ReactNativeFirebaseMessagingHeadlessService extends HeadlessJsTaskService {
    ...
    protected HeadlessJsTaskConfig getTaskConfig(Intent intent) {
        ...
        return new HeadlessJsTaskConfig(TASK_KEY, ReactNativeFirebaseMessagingSerializer.remoteMessageToWritableMap((RemoteMessage) intent.getParcelableExtra("message")), ReactNativeFirebaseJSON.getSharedInstance().getLongValue(TIMEOUT_JSON_KEY, TIMEOUT_DEFAULT), true);
    }
}
