...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    private long anrTimeoutIntervalMillis = MetricsHelper.FLUSHER_SLEEP_TIME_MS;
    ...
    private long startupCrashFlushTimeoutMillis = MetricsHelper.FLUSHER_SLEEP_TIME_MS;
    ...
    public SentryAndroidOptions() {
        setSentryClientName("sentry.java.android/7.18.1");
        setSdkVersion(createSdkVersion());
        setAttachServerName(false);
    }

    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersionUpdateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "7.18.1");
        sdkVersionUpdateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "7.18.1");
