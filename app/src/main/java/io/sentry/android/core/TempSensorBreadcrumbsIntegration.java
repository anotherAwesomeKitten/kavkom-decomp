...
public final class TempSensorBreadcrumbsIntegration implements Integration, Closeable, SensorEventListener {
            ...
            try {
                sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.TempSensorBreadcrumbsIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m877x7962c083(sentryOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* JADX INFO: renamed from: lambda$register$0$io-sentry-android-core-TempSensorBreadcrumbsIntegration, reason: not valid java name */
    /* synthetic */ void m877x7962c083(SentryOptions sentryOptions) {
        ...
        try {
            ...
            if (sensorManager != null) {
                ...
                if (defaultSensor != null) {
                    ...
                    IntegrationUtils.addIntegrationToSdkVersion("TempSensorBreadcrumbs");
                    return;
                }
