...
public final class PhoneStateBreadcrumbsIntegration implements Integration, Closeable {
            ...
            try {
                sentryOptions.getExecutorService().submit(new Runnable() { // from class: io.sentry.android.core.PhoneStateBreadcrumbsIntegration$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m872x144a89d8(iHub, sentryOptions);
                    }
                });
            } catch (Throwable th) {
    ...
    /* JADX INFO: renamed from: lambda$register$0$io-sentry-android-core-PhoneStateBreadcrumbsIntegration, reason: not valid java name */
    /* synthetic */ void m872x144a89d8(IHub iHub, SentryOptions sentryOptions) {
    ...
    private void startTelephonyListener(IHub iHub, SentryOptions sentryOptions) {
        ...
        if (telephonyManager != null) {
            try {
                ...
                IntegrationUtils.addIntegrationToSdkVersion("PhoneStateBreadcrumbs");
                return;
            } catch (Throwable th) {
