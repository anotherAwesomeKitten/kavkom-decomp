...
public final class Sentry {
    ...
    public static IHub getCurrentHub() {
        ...
        IHub iHubM830clone = mainHub.m830clone();
        threadLocal.set(iHubM830clone);
        return iHubM830clone;
    }
    ...
    static /* synthetic */ void lambda$notifyOptionsObservers$4(SentryOptions sentryOptions) {
        for (IOptionsObserver iOptionsObserver : sentryOptions.getOptionsObservers()) {
            ...
            iOptionsObserver.setReplayErrorSampleRate(sentryOptions.getExperimental().getSessionReplay().getOnErrorSampleRate());
        }
    }
