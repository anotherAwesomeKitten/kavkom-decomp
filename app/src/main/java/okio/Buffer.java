...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    /* JADX INFO: compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\b\u0010\u0005\u001a\u00020\u0006H\u0016J \u0010\u0007\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u000bH\u0016J\u0010\u0010\u0007\u001a\u00020\u00032\u0006\u0010\r\u001a\u00020\u000bH\u0016¨\u0006\u000e"}, d2 = {"okio/Buffer$outputStream$1", "Ljava/io/OutputStream;", "close", "", "flush", "toString", "", "write", "data", "", TypedValues.Cycle.S_WAVE_OFFSET, "", "byteCount", "b", "okio"}, k = 1, mv = {1, 4, 0})
    public static final class C01951 extends OutputStream {
        ...
        @Override // java.io.OutputStream
        public void write(byte[] data, int i, int byteCount) {
    ...
    /* JADX INFO: compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000'\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\b\u0010\u0004\u001a\u00020\u0005H\u0016J\b\u0010\u0006\u001a\u00020\u0003H\u0016J \u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\u00032\u0006\u0010\n\u001a\u00020\u0003H\u0016J\b\u0010\u000b\u001a\u00020\fH\u0016¨\u0006\r"}, d2 = {"okio/Buffer$inputStream$1", "Ljava/io/InputStream;", "available", "", "close", "", "read", "sink", "", TypedValues.Cycle.S_WAVE_OFFSET, "byteCount", "toString", "", "okio"}, k = 1, mv = {1, 4, 0})
    public static final class AnonymousClass1 extends InputStream {
        ...
        @Override // java.io.InputStream
        public int read(byte[] sink, int i, int byteCount) {
    ...
    public final Buffer copyTo(OutputStream out, long j, long byteCount) throws IOException {
        Intrinsics.checkNotNullParameter(out, "out");
        long j2 = j;
        Util.checkOffsetAndCount(this.size, j2, byteCount);
        if (byteCount != 0) {
            ...
            while (j3 > 0) {
                ...
                int i = (int) (((long) segment2.pos) + j2);
                int iMin = (int) Math.min(segment2.limit - i, j3);
    ...
    @Override // okio.BufferedSink
    public Buffer writeString(String str, int beginIndex, int endIndex, Charset charset) {
        Intrinsics.checkNotNullParameter(str, "string");
        Intrinsics.checkNotNullParameter(charset, "charset");
        if (!(beginIndex >= 0)) {
    ...
    public final byte m2651deprecated_getByte(long j) {
        return getByte(j);
    }
    ...
    /* JADX INFO: renamed from: -deprecated_size, reason: from getter */
    public final long getSize() {
        return this.size;
    }

    /* JADX INFO: compiled from: Buffer.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\u0011H\u0016J\u000e\u0010\u0012\u001a\u00020\n2\u0006\u0010\u0013\u001a\u00020\bJ\u0006\u0010\u0014\u001a\u00020\bJ\u000e\u0010\u0015\u001a\u00020\n2\u0006\u0010\u0016\u001a\u00020\nJ\u000e\u0010\u0017\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nR\u0014\u0010\u0003\u001a\u0004\u0018\u00010\u00048\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00068\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u0007\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\t\u001a\u00020\n8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000b\u001a\u00020\f8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\r\u001a\u0004\u0018\u00010\u000eX\u0082\u000e¢\u0006\u0002\n\u0000R\u0012\u0010\u000f\u001a\u00020\b8\u0006@\u0006X\u0087\u000e¢\u0006\u0002\n\u0000¨\u0006\u0018"}, d2 = {"Lokio/Buffer$UnsafeCursor;", "Ljava/io/Closeable;", "()V", "buffer", "Lokio/Buffer;", "data", "", ViewProps.END, "", TypedValues.Cycle.S_WAVE_OFFSET, "", "readWrite", "", "segment", "Lokio/Segment;", ViewProps.START, "close", "", "expandBuffer", "minByteCount", "next", "resizeBuffer", "newSize", "seek", "okio"}, k = 1, mv = {1, 4, 0})
    ...
    public final Buffer copyTo(Buffer out, long j, long byteCount) {
        Intrinsics.checkNotNullParameter(out, "out");
        long j2 = j;
        Util.checkOffsetAndCount(size(), j2, byteCount);
        if (byteCount != 0) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:104:0x00b3 A[EDGE_INSN: B:104:0x00b3->B:94:0x00b3 BREAK  A[LOOP:0: B:61:0x0011->B:106:?], SYNTHETIC] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:92:0x00ae A[EDGE_INSN: B:92:0x00ae->B:86:0x00ae BREAK  A[LOOP:0: B:54:0x000d->B:94:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    public int read(byte[] sink, int i, int byteCount) {
        Intrinsics.checkNotNullParameter(sink, "sink");
        Util.checkOffsetAndCount(sink.length, i, byteCount);
        Segment segment = this.head;
        if (segment == null) {
            return -1;
        }
    ...
    @Override // okio.BufferedSink
    public Buffer write(ByteString byteString, int i, int byteCount) {
        Intrinsics.checkNotNullParameter(byteString, "byteString");
    ...
    @Override // okio.BufferedSink
    public Buffer writeUtf8(String str, int beginIndex, int endIndex) {
        int i;
        Intrinsics.checkNotNullParameter(str, "string");
        if (!(beginIndex >= 0)) {
            throw new IllegalArgumentException(("beginIndex < 0: " + beginIndex).toString());
        ...
        while (beginIndex < endIndex) {
            char cCharAt = str.charAt(beginIndex);
            if (cCharAt < 128) {
                Segment segmentWritableSegment$okio = writableSegment$okio(1);
                ...
                if (cCharAt < 2048) {
                    ...
                    i = beginIndex + 1;
                    char cCharAt3 = i < endIndex ? str.charAt(i) : (char) 0;
    ...
    @Override // okio.BufferedSink
    public Buffer write(byte[] source, int i, int byteCount) {
        Intrinsics.checkNotNullParameter(source, "source");
        long j = byteCount;
        ...
        while (i < i2) {
            ...
            int i3 = i + iMin;
            ArraysKt.copyInto(source, segmentWritableSegment$okio.data, segmentWritableSegment$okio.limit, i, i3);
            segmentWritableSegment$okio.limit += iMin;
            i = i3;
        }
        setSize$okio(size() + j);
    ...
    @Override // okio.BufferedSource
    public boolean rangeEquals(long j, ByteString bytes, int bytesOffset, int byteCount) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        if (j < 0 || bytesOffset < 0 || byteCount < 0 || size() - j < byteCount || bytes.size() - bytesOffset < byteCount) {
            return false;
        }
        for (int i = 0; i < byteCount; i++) {
            if (getByte(((long) i) + j) != bytes.getByte(bytesOffset + i)) {
                return false;
            }
        }
        return true;
