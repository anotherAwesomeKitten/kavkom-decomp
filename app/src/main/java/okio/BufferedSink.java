...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    BufferedSink write(ByteString byteString, int i, int byteCount) throws IOException;

    BufferedSink write(Source source, long byteCount) throws IOException;

    BufferedSink write(byte[] source) throws IOException;

    BufferedSink write(byte[] source, int i, int byteCount) throws IOException;
    ...
    BufferedSink writeString(String str, int beginIndex, int endIndex, Charset charset) throws IOException;
    ...
    BufferedSink writeUtf8(String str, int beginIndex, int endIndex) throws IOException;
