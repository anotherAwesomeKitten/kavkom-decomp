...
public final class RealBufferedSink implements BufferedSink {
    ...
    /* JADX INFO: compiled from: RealBufferedSink.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000)\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0016J\b\u0010\u0004\u001a\u00020\u0003H\u0016J\b\u0010\u0005\u001a\u00020\u0006H\u0016J \u0010\u0007\u001a\u00020\u00032\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\u000bH\u0016J\u0010\u0010\u0007\u001a\u00020\u00032\u0006\u0010\r\u001a\u00020\u000bH\u0016¨\u0006\u000e"}, d2 = {"okio/RealBufferedSink$outputStream$1", "Ljava/io/OutputStream;", "close", "", "flush", "toString", "", "write", "data", "", TypedValues.Cycle.S_WAVE_OFFSET, "", "byteCount", "b", "okio"}, k = 1, mv = {1, 4, 0})
    public static final class AnonymousClass1 extends OutputStream {
        ...
        @Override // java.io.OutputStream
        public void write(byte[] data, int i, int byteCount) throws IOException {
            Intrinsics.checkNotNullParameter(data, "data");
            if (RealBufferedSink.this.closed) {
                throw new IOException("closed");
            }
            RealBufferedSink.this.bufferField.write(data, i, byteCount);
            RealBufferedSink.this.emitCompleteSegments();
        }
    ...
    @Override // okio.BufferedSink
    public BufferedSink write(ByteString byteString, int i, int byteCount) {
        Intrinsics.checkNotNullParameter(byteString, "byteString");
        if (this.closed) {
            throw new IllegalStateException("closed".toString());
        }
    ...
    @Override // okio.BufferedSink
    public BufferedSink write(byte[] source, int i, int byteCount) {
        Intrinsics.checkNotNullParameter(source, "source");
        if (this.closed) {
            throw new IllegalStateException("closed".toString());
        }
