...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    boolean rangeEquals(long j, ByteString bytes) throws IOException;

    boolean rangeEquals(long j, ByteString bytes, int bytesOffset, int byteCount) throws IOException;

    int read(byte[] sink) throws IOException;

    int read(byte[] sink, int i, int byteCount) throws IOException;
