...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM946constructorimpl = Result.m946constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM946constructorimpl = Result.m946constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m952isFailureimpl(objM946constructorimpl) ? null : objM946constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2503dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
