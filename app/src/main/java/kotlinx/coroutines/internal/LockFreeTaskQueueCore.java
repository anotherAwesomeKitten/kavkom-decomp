...
public final class LockFreeTaskQueueCore<E> {
    ...
    */
    ...
    private final LockFreeTaskQueueCore<E> fillPlaceholder(int i, E element) {
    ...
    private final LockFreeTaskQueueCore<E> allocateNextCopy(long j) {
        ...
        while (true) {
            ...
            if ((i & i3) != (i2 & i3)) {
                ...
                _state$FU.set(lockFreeTaskQueueCore, INSTANCE.wo(j, FROZEN_MASK));
                return lockFreeTaskQueueCore;
            }
        }
    }
        ...
        while (true) {
            ...
            if ((i & i3) != (i2 & i3)) {
                ...
                if (artificialStackFrames != null && !(artificialStackFrames instanceof Placeholder)) {
                    arrayList.add(function1.invoke(artificialStackFrames));
                }
                i++;
            } else {
                return arrayList;
