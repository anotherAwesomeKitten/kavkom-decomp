...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM946constructorimpl2;
        ...
        try {
            ...
            objM946constructorimpl = Result.m946constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM946constructorimpl = Result.m946constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m949exceptionOrNullimpl(objM946constructorimpl) == null) {
            obj2 = objM946constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM946constructorimpl2 = Result.m946constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM946constructorimpl2 = Result.m946constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m949exceptionOrNullimpl(objM946constructorimpl2) == null) {
            obj = objM946constructorimpl2;
        }
