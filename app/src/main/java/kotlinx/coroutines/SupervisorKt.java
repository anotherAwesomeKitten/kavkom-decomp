...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m2442SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* JADX INFO: renamed from: SupervisorJob$default */
    public static /* synthetic */ Job m2443SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2442SupervisorJob(job);
    }
