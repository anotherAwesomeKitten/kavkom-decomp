...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2504scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2435delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m2436toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2436toDelayMillisLRDsOJo(long j) {
        if (Duration.m2291compareToLRDsOJo(j, Duration.INSTANCE.m2383getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2303getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
