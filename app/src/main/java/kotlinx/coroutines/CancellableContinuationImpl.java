...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final void multipleHandlersError(Object handler, Object obj) {
    ...
    private final Object resumedState(NotCompleted notCompleted, Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation, Object idempotent) {
        ...
        if ((DispatchedTaskKt.isCancellableMode(resumeMode) || idempotent != null) && (onCancellation != null || (notCompleted instanceof CancelHandler) || idempotent != null)) {
            return new CompletedContinuation(proposedUpdate, notCompleted instanceof CancelHandler ? (CancelHandler) notCompleted : null, onCancellation, idempotent, null, 16, null);
        }
        return proposedUpdate;
    }
