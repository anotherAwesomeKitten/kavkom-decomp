...
public final class ExecutorCoroutineDispatcherImpl extends ExecutorCoroutineDispatcher implements Delay {
    ...
    public void mo2503dispatch(CoroutineContext context, Runnable block) {
        ...
        try {
            ...
            Dispatchers.getIO().mo2503dispatch(context, block);
        }
    }

    @Override // kotlinx.coroutines.Delay
    /* JADX INFO: renamed from: scheduleResumeAfterDelay */
    public void mo2504scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        long j;
        Executor executor = getExecutor();
        ...
        if (scheduledFutureScheduleBlock != null) {
            ...
            DefaultExecutor.INSTANCE.mo2504scheduleResumeAfterDelay(j, continuation);
        }
    }
    ...
    private final void cancelJobOnRejection(CoroutineContext context, RejectedExecutionException rejectedExecutionException) {
        JobKt.cancel(context, ExceptionsKt.CancellationException("The task was rejected", rejectedExecutionException));
    }
