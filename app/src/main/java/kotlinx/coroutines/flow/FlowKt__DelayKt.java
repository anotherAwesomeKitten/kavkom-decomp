...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    static final class AnonymousClass2<T> extends Lambda implements Function1<T, Long> {
    ...
    public static final <T> Flow<T> m2480debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m2436toDelayMillisLRDsOJo(j));
    }
    ...
    static final class AnonymousClass3<T> extends Lambda implements Function1<T, Long> {
        final /* synthetic */ Function1<T, Duration> $timeout;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        AnonymousClass3(Function1<? super T, Duration> function1) {
            super(1);
            function1 = function1;
        }
        ...
        @Override // kotlin.jvm.functions.Function1
        public final Long invoke(T t) {
            return Long.valueOf(DelayKt.m2436toDelayMillisLRDsOJo(function1.invoke(t).getRawValue()));
        }
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt.debounce.3
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            AnonymousClass3(Function1<? super T, Duration> function12) {
                super(1);
    ...
    public static final <T> Flow<T> sample(Flow<? extends T> flow, long j) {
        ...
        return FlowCoroutineKt.scopedFlow(new C01722(j, flow, null));
    }
    ...
    public static final ReceiveChannel<Unit> fixedPeriodTicker(CoroutineScope coroutineScope, long j, long j2) {
        ...
        return ProduceKt.produce$default(coroutineScope, null, 0, new C01713(j2, j, null), 1, null);
    }
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__DelayKt$fixedPeriodTicker$3", f = "Delay.kt", i = {0, 1, 2}, l = {313, 315, TypedValues.Attributes.TYPE_PATH_ROTATE}, m = "invokeSuspend", n = {"$this$produce", "$this$produce", "$this$produce"}, s = {"L$0", "L$0", "L$0"})
    static final class C01713 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Removed duplicated region for block: B:39:0x0056 A[PHI: r1
          0x0056: PHI (r1v4 kotlinx.coroutines.channels.ProducerScope) = (r1v3 kotlinx.coroutines.channels.ProducerScope), (r1v8 kotlinx.coroutines.channels.ProducerScope) binds: [B:37:0x0053, B:31:0x001a] A[DONT_GENERATE, DONT_INLINE]] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:40:0x0063 -> B:36:0x0042). Please report as a decompilation issue!!! */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
    ...
    public static final <T> Flow<T> m2481sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m2436toDelayMillisLRDsOJo(j));
    }

    /* JADX INFO: renamed from: timeout-HG0u8IE */
    public static final <T> Flow<T> m2482timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2483timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* JADX INFO: renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt */
    private static final <T> Flow<T> m2483timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
