...
public interface ReceiveChannel<E> {
    ...
    Object mo2451receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo2452tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2452tryReceivePtdJZtk = receiveChannel.mo2452tryReceivePtdJZtk();
            if (ChannelResult.m2467isSuccessimpl(objMo2452tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2463getOrThrowimpl(objMo2452tryReceivePtdJZtk);
            }
            Throwable thM2461exceptionOrNullimpl = ChannelResult.m2461exceptionOrNullimpl(objMo2452tryReceivePtdJZtk);
            if (thM2461exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2461exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo2451receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m2462getOrNullimpl(r4)
                return r4
            */
