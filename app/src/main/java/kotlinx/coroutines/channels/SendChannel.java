...
public interface SendChannel<E> {
    ...
    Object mo2447trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2467isSuccessimpl(objMo2447trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2461exceptionOrNullimpl = ChannelResult.m2461exceptionOrNullimpl(objMo2447trySendJP2dKIU);
