...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM946constructorimpl = Result.m946constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM946constructorimpl = Result.m946constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m2457boximpl(Result.m953isSuccessimpl(objM946constructorimpl) ? ChannelResult.INSTANCE.m2472successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m2470closedJP2dKIU(Result.m949exceptionOrNullimpl(objM946constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo2447trySendJP2dKIU = sendChannel.mo2447trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m2467isSuccessimpl(sendChannel.mo2447trySendJP2dKIU(obj))) {
            return;
        }
