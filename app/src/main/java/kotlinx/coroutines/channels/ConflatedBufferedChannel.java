...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM2475trySendImplMj0NB7M = conflatedBufferedChannel.m2475trySendImplMj0NB7M(e, true);
        if (objM2475trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2461exceptionOrNullimpl(objM2475trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM2475trySendImplMj0NB7M = conflatedBufferedChannel.m2475trySendImplMj0NB7M(e, true);
        if (!(objM2475trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo2447trySendJP2dKIU(E element) {
        return m2475trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m2475trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2473trySendDropLatestMj0NB7M(element, isSendOp) : m2474trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m2473trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo2447trySendJP2dKIU = super.mo2447trySendJP2dKIU(element);
        if (ChannelResult.m2467isSuccessimpl(objMo2447trySendJP2dKIU) || ChannelResult.m2465isClosedimpl(objMo2447trySendJP2dKIU)) {
            return objMo2447trySendJP2dKIU;
        }
    ...
    private final Object m2474trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo2447trySendJP2dKIU = mo2447trySendJP2dKIU(element);
        if (!(objMo2447trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo2447trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m2461exceptionOrNullimpl(objMo2447trySendJP2dKIU);
