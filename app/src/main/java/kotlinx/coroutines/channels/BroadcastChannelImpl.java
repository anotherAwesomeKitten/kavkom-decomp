...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo2447trySendJP2dKIU(getValue());
                }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:71:0x007d -> B:72:0x0080). Please report as a decompilation issue!!! */
    ...
    */
    ...
    public Object mo2447trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo2447trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo2447trySendJP2dKIU(element);
            }
