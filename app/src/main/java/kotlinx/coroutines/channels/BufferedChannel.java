...
public class BufferedChannel<E> implements Channel<E> {
    ...
    public Object mo2451receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        return m2449receiveCatchingJP2dKIU$suspendImpl(this, continuation);
    }
    ...
    public final void onClosedSendOnNoWaiterSuspend(E element, CancellableContinuation<? super Unit> cont) {
        ...
        cancellableContinuation.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(sendException)));
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo2447trySendJP2dKIU(E element) {
        ChannelSegment channelSegmentFindSegmentSend;
        int i;
        BufferedChannel<E> bufferedChannel;
        if (shouldSendSuspend(sendersAndCloseStatus$FU.get(this))) {
            return ChannelResult.INSTANCE.m2471failurePtdJZtk();
        }
        ...
        while (true) {
            ...
            if (channelSegment.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m2470closedJP2dKIU(getSendException());
                }
            } else {
            ...
            if (iUpdateCellSend == 0) {
                channelSegment.cleanPrev();
                return ChannelResult.INSTANCE.m2472successJP2dKIU(Unit.INSTANCE);
            }
            if (iUpdateCellSend == 1) {
                return ChannelResult.INSTANCE.m2472successJP2dKIU(Unit.INSTANCE);
            }
    ...
    public static final class C01311 extends Lambda implements Function4 {
    ...
    public static /* synthetic */ Object sendImpl$default(BufferedChannel bufferedChannel, Object obj, Object obj2, Function0 function0, Function2 function2, Function0 function02, Function4 function4, int i, Object obj3) {
        ...
        Function4 function42 = (i & 32) != 0 ? C01311.INSTANCE : function4;
    ...
    private final void sendImplOnNoWaiter(ChannelSegment<E> segment, int i, E element, long s, Waiter waiter, Function0<Unit> onRendezvousOrBuffered, Function0<Unit> onClosed) {
        ...
        if (iUpdateCellSend == 2) {
            prepareSenderForSuspension(waiter, segment, i);
            return;
        }
        if (iUpdateCellSend == 4) {
        ...
        if (iUpdateCellSend == 5) {
            ...
            while (true) {
                ...
                int iUpdateCellSend2 = updateCellSend(channelSegment, i2, element, j, waiter, zIsClosedForSend0);
    ...
    private final int updateCellSendSlow(ChannelSegment<E> segment, int i, E element, long s, Object waiter, boolean closed) {
        while (true) {
            Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(i);
            if (state$kotlinx_coroutines_core != null) {
    ...
    private final boolean tryResumeReceiver(Object obj, E e) {
        ...
        if (obj instanceof ReceiveCatching) {
            ...
            ChannelResult channelResultM2457boximpl = ChannelResult.m2457boximpl(ChannelResult.INSTANCE.m2472successJP2dKIU(e));
            Function1<E, Unit> function1 = this.onUndeliveredElement;
            return BufferedChannelKt.tryResume0(cancellableContinuationImpl, channelResultM2457boximpl, function1 != null ? OnUndeliveredElementKt.bindCancellationFun(function1, e, receiveCatching.cont.getContext()) : null);
        }
    ...
    public final void onClosedReceiveOnNoWaiterSuspend(CancellableContinuation<? super E> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(getReceiveException())));
    }
    ...
    */
    static /* synthetic */ <E> java.lang.Object m2449receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel<E> r13, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r14) throws java.lang.Throwable {
        /*
        ...
        L46:
            ...
            java.lang.Object r13 = r14.m2470closedJP2dKIU(r13)
            return r13
        L57:
        ...
        L9d:
            ...
            r6.label = r2
            r2 = r8
            java.lang.Object r13 = r1.m2450receiveCatchingOnNoWaiterSuspendGKJJFZk(r2, r3, r4, r6)
            if (r13 != r0) goto Lad
            return r0
        Lad:
            return r13
        Lae:
            r8.cleanPrev()
            kotlinx.coroutines.channels.ChannelResult$Companion r14 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r13 = r14.m2472successJP2dKIU(r13)
            return r13
        Lb8:
            java.lang.IllegalStateException r13 = new java.lang.IllegalStateException
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2449receiveCatchingJP2dKIU$suspendImpl(kotlinx.coroutines.channels.BufferedChannel, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:100:0x0014  */
    /* JADX INFO: renamed from: receiveCatchingOnNoWaiterSuspend-GKJJFZk */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final java.lang.Object m2450receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment<E> r11, int r12, long r13, kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r15) throws java.lang.Throwable {
        /*
            Method dump skipped, instruction units count: 352
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.BufferedChannel.m2450receiveCatchingOnNoWaiterSuspendGKJJFZk(kotlinx.coroutines.channels.ChannelSegment, int, long, kotlin.coroutines.Continuation):java.lang.Object");
    }

    public final void onClosedReceiveCatchingOnNoWaiterSuspend(CancellableContinuation<? super ChannelResult<? extends E>> cont) {
        Result.Companion companion = Result.INSTANCE;
        cont.resumeWith(Result.m946constructorimpl(ChannelResult.m2457boximpl(ChannelResult.INSTANCE.m2470closedJP2dKIU(getCloseCause()))));
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* JADX INFO: renamed from: tryReceive-PtdJZtk */
    public Object mo2452tryReceivePtdJZtk() {
        ChannelSegment channelSegment;
        long j = receivers$FU.get(this);
        long j2 = sendersAndCloseStatus$FU.get(this);
        if (isClosedForReceive0(j2)) {
            return ChannelResult.INSTANCE.m2470closedJP2dKIU(getCloseCause());
        }
            ...
            while (!isClosedForReceive()) {
                ...
                if (objUpdateCellReceive != BufferedChannelKt.SUSPEND) {
                    if (objUpdateCellReceive != BufferedChannelKt.FAILED) {
                        ...
                        return ChannelResult.INSTANCE.m2472successJP2dKIU(objUpdateCellReceive);
                    }
    ...
    static /* synthetic */ Object receiveImpl$default(BufferedChannel bufferedChannel, Object obj, Function1 function1, Function3 function3, Function0 function0, Function3 function32, int i, Object obj2) {
        ...
        if ((i & 16) != 0) {
            function32 = AnonymousClass1.INSTANCE;
        }
    ...
    private final void receiveImplOnNoWaiter(ChannelSegment<E> segment, int i, long r, Waiter waiter, Function1<? super E, Unit> onElementRetrieved, Function0<Unit> onClosed) {
        ChannelSegment channelSegment;
        ...
        if (symbol != BufferedChannelKt.SUSPEND) {
            ...
            while (!isClosedForReceive()) {
                ...
                BufferedChannel<E> bufferedChannel2 = bufferedChannel;
                Symbol symbol2 = (Object) bufferedChannel2.updateCellReceive(channelSegment, i2, andIncrement, waiter);
                channelSegment2 = channelSegment;
                if (symbol2 != BufferedChannelKt.SUSPEND) {
                    ...
                    Waiter waiter2 = waiter instanceof Waiter ? waiter : null;
                    if (waiter2 != null) {
                        prepareReceiverForSuspension(waiter2, channelSegment2, i2);
                    }
                    Unit unit = Unit.INSTANCE;
                    return;
                }
    ...
    private final Object updateCellReceiveSlow(ChannelSegment<E> segment, int i, long r, Object waiter) {
        while (true) {
            Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(i);
    ...
    private final boolean updateCellExpandBuffer(ChannelSegment<E> segment, int i, long b) {
        Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(i);
    ...
    private final boolean updateCellExpandBufferSlow(ChannelSegment<E> segment, int i, long b) {
        while (true) {
            Object state$kotlinx_coroutines_core = segment.getState$kotlinx_coroutines_core(i);
    ...
    public final Object processResultSelectReceiveCatching(Object ignoredParam, Object selectResult) {
        return ChannelResult.m2457boximpl(selectResult == BufferedChannelKt.getCHANNEL_CLOSED() ? ChannelResult.INSTANCE.m2470closedJP2dKIU(getCloseCause()) : ChannelResult.INSTANCE.m2472successJP2dKIU(selectResult));
    }
    ...
    private final class BufferedChannelIterator implements ChannelIterator<E>, Waiter {
        ...
        public final void onClosedHasNextNoWaiterSuspend() {
            ...
            if (closeCause == null) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m946constructorimpl(false));
                return;
            }
            ...
            cancellableContinuationImpl2.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(closeCause)));
        }
    ...
    protected boolean closeOrCancelImpl(Throwable cause, boolean z) {
        if (z) {
    ...
    */
    ...
    private final void cancelSuspendedReceiveRequests(ChannelSegment<E> lastSegment, long sendersCounter) {
        Object objM2494constructorimpl$default = InlineList.m2494constructorimpl$default(null, 1, null);
            ...
            for (int i = BufferedChannelKt.SEGMENT_SIZE - 1; -1 < i; i--) {
                ...
                while (true) {
                    ...
                    if (state$kotlinx_coroutines_core == null || state$kotlinx_coroutines_core == BufferedChannelKt.IN_BUFFER) {
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2494constructorimpl$default = InlineList.m2499plusFjFbRPM(objM2494constructorimpl$default, ((WaiterEB) state$kotlinx_coroutines_core).waiter);
                        ...
                        if (lastSegment.casState$kotlinx_coroutines_core(i, state$kotlinx_coroutines_core, BufferedChannelKt.getCHANNEL_CLOSED())) {
                            objM2494constructorimpl$default = InlineList.m2499plusFjFbRPM(objM2494constructorimpl$default, state$kotlinx_coroutines_core);
                            lastSegment.onCancelledRequest(i, true);
                            break;
                        }
                    }
        ...
        if (objM2494constructorimpl$default != null) {
            if (!(objM2494constructorimpl$default instanceof ArrayList)) {
                resumeReceiverOnClosedChannel((Waiter) objM2494constructorimpl$default);
                return;
            }
            Intrinsics.checkNotNull(objM2494constructorimpl$default, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
            ArrayList arrayList = (ArrayList) objM2494constructorimpl$default;
    ...
    private final void resumeWaiterOnClosedChannel(Waiter waiter, boolean z) {
        if (waiter instanceof SendBroadcast) {
            ...
            Result.Companion companion = Result.INSTANCE;
            cont.resumeWith(Result.m946constructorimpl(false));
            return;
        }
        if (waiter instanceof CancellableContinuation) {
            Continuation continuation = (Continuation) waiter;
            Result.Companion companion2 = Result.INSTANCE;
            continuation.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(z ? getReceiveException() : getSendException())));
            ...
            cancellableContinuationImpl.resumeWith(Result.m946constructorimpl(ChannelResult.m2457boximpl(ChannelResult.INSTANCE.m2470closedJP2dKIU(getCloseCause()))));
    ...
    private final boolean isCellNonEmpty(ChannelSegment<E> segment, int i, long globalIndex) {
    ...
    public final ChannelSegment<E> findSegmentSend(long id, ChannelSegment<E> startFrom) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m2511isClosedimpl(objFindSegmentInternal)) {
                Segment segmentM2509getSegmentimpl = SegmentOrClosed.m2509getSegmentimpl(objFindSegmentInternal);
                while (true) {
                    Segment segment = (Segment) atomicReferenceFieldUpdater.get(this);
                    if (segment.id >= segmentM2509getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM2509getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, segment, segmentM2509getSegmentimpl)) {
                        if (segment.decPointers$kotlinx_coroutines_core()) {
                            segment.remove();
                        }
                    } else if (segmentM2509getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
                        segmentM2509getSegmentimpl.remove();
                    }
                }
            } else {
                break;
        ...
        ChannelSegment<E> channelSegment = (ChannelSegment) SegmentOrClosed.m2509getSegmentimpl(objFindSegmentInternal);
    ...
    */
    ...
    public final Object onClosedSend(E e, Continuation<? super Unit> continuation) {
        ...
        if (function1 != null && (undeliveredElementExceptionCallUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            cancellableContinuationImpl3.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(undeliveredElementExceptionRecoverFromStackFrame)));
        } else {
            ...
            cancellableContinuationImpl4.resumeWith(Result.m946constructorimpl(ResultKt.createFailure(sendException)));
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:162:0x011d A[RETURN] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:103:0x00b1, code lost:
        ...
        r1.resumeWith(kotlin.Result.m946constructorimpl(kotlin.coroutines.jvm.internal.Boxing.boxBoolean(true)));
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
