...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM946constructorimpl = Result.m946constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM946constructorimpl = Result.m946constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m952isFailureimpl(objM946constructorimpl) ? null : objM946constructorimpl);
