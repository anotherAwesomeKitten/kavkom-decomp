...
public final class MutableObjectList<E> extends ObjectList<E> {
    ...
    public final void add(int i, E element) {
        if (i < 0 || i > this._size) {
    ...
    public final boolean addAll(int i, E[] elements) {
        ...
        Object[] objArr = this.content;
        if (i != this._size) {
            ArraysKt.copyInto(objArr, objArr, elements.length + i, i, this._size);
        }
        ArraysKt.copyInto$default(elements, objArr, i, 0, 0, 12, (Object) null);
    ...
    public final boolean addAll(int i, Collection<? extends E> elements) {
        ...
        Object[] objArr = this.content;
        if (i != this._size) {
            ArraysKt.copyInto(objArr, objArr, elements.size() + i, i, this._size);
        }
    ...
    public final boolean addAll(int i, ObjectList<E> elements) {
        ...
        Object[] objArr = this.content;
        if (i != this._size) {
            ArraysKt.copyInto(objArr, objArr, elements._size + i, i, this._size);
        }
        ArraysKt.copyInto(elements.content, objArr, i, 0, elements._size);
    ...
    public final E set(int i, E element) {
        if (i < 0 || i >= this._size) {
    ...
    private static final class MutableObjectListIterator<T> implements ListIterator<T>, KMutableListIterator {
        ...
        @Override // java.util.ListIterator
        /* JADX INFO: renamed from: previousIndex, reason: from getter */
