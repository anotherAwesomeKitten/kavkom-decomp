...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:41:0x006c, code lost:
        ...
        if (((r5 & ((~r5) << 6)) & (-9187201950435737472L)) == 0) goto L48;
     */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0075, code lost:
        ...
        if (((r8 & ((~r8) << 6)) & (-9187201950435737472L)) == 0) goto L50;
     */
    ...
    */
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compare(ULong.m1121constructorimpl(ULong.m1121constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m1121constructorimpl(ULong.m1121constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
    ...
    private final void writeMetadata(int i, long value) {
        long[] jArr = this.metadata;
        int i2 = i >> 3;
        int i3 = (i & 7) << 3;
