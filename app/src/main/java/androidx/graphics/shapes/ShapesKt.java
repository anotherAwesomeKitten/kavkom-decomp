...
public final class ShapesKt {
    ...
    private static final float[] pillStarVerticesFromNumVerts(int i, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        ...
        long jM10constructorimpl2 = FloatFloatPair.m10constructorimpl(f12, f11);
        float f24 = -f12;
        long jM10constructorimpl3 = FloatFloatPair.m10constructorimpl(f24, f11);
        float f25 = -f11;
        long jM10constructorimpl4 = FloatFloatPair.m10constructorimpl(f24, f25);
        long jM10constructorimpl5 = FloatFloatPair.m10constructorimpl(f12, f25);
        float f26 = f11;
        int i3 = 0;
        float f27 = 0.0f;
        boolean z = false;
                ...
                if (f28 >= f29) {
                    ...
                    switch (i4) {
                        case 0:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = FloatFloatPair.m10constructorimpl(f31, f30 * f8);
                            break;
                        case 1:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = PointKt.m107plusybeJwSQ(Utils.m123radialToCartesianL6JJ3z0$default(f31, (f30 * Utils.getFloatPi()) / f10, 0L, 4, null), jM10constructorimpl2);
                            break;
                        case 2:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = FloatFloatPair.m10constructorimpl(f9 - (f30 * fCoerceAtLeast2), f31);
                            break;
                        case 3:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = PointKt.m107plusybeJwSQ(Utils.m123radialToCartesianL6JJ3z0$default(f31, (Utils.getFloatPi() / f10) + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM10constructorimpl3);
                            break;
                        case 4:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = FloatFloatPair.m10constructorimpl(-f31, f8 - (f30 * fCoerceAtLeast));
                            break;
                        case 5:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = PointKt.m107plusybeJwSQ(Utils.m123radialToCartesianL6JJ3z0$default(f31, Utils.getFloatPi() + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM10constructorimpl4);
                            break;
                        case 6:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = FloatFloatPair.m10constructorimpl(f24 + (f30 * fCoerceAtLeast2), -f31);
                            break;
                        case 7:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = PointKt.m107plusybeJwSQ(Utils.m123radialToCartesianL6JJ3z0$default(f31, (Utils.getFloatPi() * 1.5f) + ((f30 * Utils.getFloatPi()) / f10), 0L, 4, null), jM10constructorimpl5);
                            break;
                        default:
                            f8 = f11;
                            f9 = f12;
                            jM10constructorimpl = FloatFloatPair.m10constructorimpl(f31, f25 + (f30 * f8));
                            break;
                    }
                    int i7 = i5 + 1;
                    fArr2[i5] = PointKt.m103getXDnnuFBc(jM10constructorimpl) + f6;
                    i5 += 2;
                    fArr2[i7] = PointKt.m104getYDnnuFBc(jM10constructorimpl) + f7;
                    f23 += f22;
                    z = !z;
                    i3++;
                    f11 = f8;
    ...
    private static final float[] starVerticesFromNumVerts(int i, float f, float f2, float f3, float f4) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f5 = i;
            long jM123radialToCartesianL6JJ3z0$default = Utils.m123radialToCartesianL6JJ3z0$default(f, (Utils.getFloatPi() / f5) * 2 * i3, 0L, 4, null);
            fArr[i2] = PointKt.m103getXDnnuFBc(jM123radialToCartesianL6JJ3z0$default) + f3;
            fArr[i2 + 1] = PointKt.m104getYDnnuFBc(jM123radialToCartesianL6JJ3z0$default) + f4;
            long jM123radialToCartesianL6JJ3z0$default2 = Utils.m123radialToCartesianL6JJ3z0$default(f2, (Utils.getFloatPi() / f5) * ((i3 * 2) + 1), 0L, 4, null);
            int i4 = i2 + 3;
            fArr[i2 + 2] = PointKt.m103getXDnnuFBc(jM123radialToCartesianL6JJ3z0$default2) + f3;
            i2 += 4;
            fArr[i4] = PointKt.m104getYDnnuFBc(jM123radialToCartesianL6JJ3z0$default2) + f4;
        }
        return fArr;
    }
}
