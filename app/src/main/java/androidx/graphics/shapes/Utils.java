...
public final class Utils {
    ...
    public static final long directionVector(float f, float f2) {
        ...
        return FloatFloatPair.m10constructorimpl(f / fDistance, f2 / fDistance);
    }
    ...
    public static /* synthetic */ long m123radialToCartesianL6JJ3z0$default(float f, float f2, long j, int i, Object obj) {
        if ((i & 4) != 0) {
            j = Zero;
        }
        return m122radialToCartesianL6JJ3z0(f, f2, j);
    }

    /* JADX INFO: renamed from: radialToCartesian-L6JJ3z0, reason: not valid java name */
    public static final long m122radialToCartesianL6JJ3z0(float f, float f2, long j) {
        return PointKt.m107plusybeJwSQ(PointKt.m109timesso9K2fw(directionVector(f2), f), j);
    }

    /* JADX INFO: renamed from: rotate90-DnnuFBc, reason: not valid java name */
    public static final long m124rotate90DnnuFBc(long j) {
        return FloatFloatPair.m10constructorimpl(-PointKt.m104getYDnnuFBc(j), PointKt.m103getXDnnuFBc(j));
    }
