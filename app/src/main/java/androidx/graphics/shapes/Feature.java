...
public abstract class Feature {
    ...
    public static final class Corner extends Feature {
        ...
        public Feature transformed$graphics_shapes_release(PointTransformer f) {
            ...
            return new Corner(CollectionsKt.build(listCreateListBuilder), PointKt.m110transformedso9K2fw(this.vertex, f), PointKt.m110transformedso9K2fw(this.roundedCenter, f), this.convex, null);
        }
