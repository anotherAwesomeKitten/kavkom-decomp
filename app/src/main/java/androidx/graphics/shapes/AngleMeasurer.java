...
public final class AngleMeasurer implements Measurer {
    ...
    public static final float findCubicCutPoint$lambda$1(Cubic c, AngleMeasurer this$0, float f, float f2, float f3) {
        ...
        long jM91pointOnCurveOOQOV4g$graphics_shapes_release = c.m91pointOnCurveOOQOV4g$graphics_shapes_release(f3);
        return Math.abs(Utils.positiveModulo(Utils.angle(PointKt.m103getXDnnuFBc(jM91pointOnCurveOOQOV4g$graphics_shapes_release) - this$0.centerX, PointKt.m104getYDnnuFBc(jM91pointOnCurveOOQOV4g$graphics_shapes_release) - this$0.centerY) - f, Utils.getTwoPi()) - f2);
    }
}
