...
public class Direct {
    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            Iterator<ConstraintAnchor> it = anchor2.getDependents().iterator();
            while (it.hasNext()) {
                ...
                boolean z2 = (next == constraintWidget3.mLeft && constraintWidget3.mRight.mTarget != null && constraintWidget3.mRight.mTarget.hasFinalValue()) || (next == constraintWidget3.mRight && constraintWidget3.mLeft.mTarget != null && constraintWidget3.mLeft.mTarget.hasFinalValue());
    ...
    private static void verticalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            for (ConstraintAnchor constraintAnchor : anchor.getDependents()) {
                ...
                if (constraintWidget2.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || zCanMeasure) {
                    ...
                    if (!constraintWidget2.isInVerticalChain() && !constraintWidget2.isInVirtualLayout() && ((constraintAnchor == constraintWidget2.mTop && constraintWidget2.mBottom.mTarget != null && constraintWidget2.mBottom.mTarget.hasFinalValue()) || (constraintAnchor == constraintWidget2.mBottom && constraintWidget2.mTop.mTarget != null && constraintWidget2.mTop.mTarget.hasFinalValue()))) {
                        if (!constraintWidget2.isInVerticalChain()) {
        ...
        if (anchor3.getDependents() != null && anchor3.hasFinalValue()) {
            ...
            for (ConstraintAnchor constraintAnchor2 : anchor3.getDependents()) {
                ...
                if (constraintWidget4.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT || zCanMeasure3) {
                    if (!constraintWidget4.isMeasureRequested() && constraintAnchor2 == constraintWidget4.mBaseline) {
                        constraintWidget4.setFinalBaseline(constraintAnchor2.getMargin() + finalValue3);
