...
public final class Instant implements Comparable<Instant>, Serializable {
    ...
    public final Instant m2390minusLRDsOJo(long duration) {
        return m2392plusLRDsOJo(Duration.m2336unaryMinusUwyO8pc(duration));
    }

    /* JADX INFO: renamed from: minus-UwyO8pc, reason: not valid java name */
    public final long m2391minusUwyO8pc(Instant other) {
        Intrinsics.checkNotNullParameter(other, "other");
        Duration.Companion companion = Duration.INSTANCE;
        long duration = DurationKt.toDuration(this.epochSeconds - other.epochSeconds, DurationUnit.SECONDS);
        Duration.Companion companion2 = Duration.INSTANCE;
        return Duration.m2321plusLRDsOJo(duration, DurationKt.toDuration(this.nanosecondsOfSecond - other.nanosecondsOfSecond, DurationUnit.NANOSECONDS));
    }
    ...
    public final Instant m2392plusLRDsOJo(long duration) {
        long jM2306getInWholeSecondsimpl = Duration.m2306getInWholeSecondsimpl(duration);
        int iM2308getNanosecondsComponentimpl = Duration.m2308getNanosecondsComponentimpl(duration);
        if (jM2306getInWholeSecondsimpl == 0 && iM2308getNanosecondsComponentimpl == 0) {
            return this;
        }
        long j = this.epochSeconds;
        long j2 = j + jM2306getInWholeSecondsimpl;
        if ((j ^ j2) >= 0 || (jM2306getInWholeSecondsimpl ^ j) < 0) {
            return INSTANCE.fromEpochSeconds(j2, this.nanosecondsOfSecond + iM2308getNanosecondsComponentimpl);
        }
        return Duration.m2319isPositiveimpl(duration) ? MAX : MIN;
    }
}
