...
public final class DurationKt {
    ...
    private static final long m2389timesmvk6XK0(int i, long j) {
        return Duration.m2323timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk */
    private static final long m2388timeskIfJnKk(double d, long j) {
        return Duration.m2322timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM2383getZEROUwyO8pc = Duration.INSTANCE.m2383getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM2321plusLRDsOJo = Duration.m2321plusLRDsOJo(jM2383getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM2383getZEROUwyO8pc = Duration.m2321plusLRDsOJo(jM2321plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM2383getZEROUwyO8pc = Duration.m2321plusLRDsOJo(jM2383getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM2383getZEROUwyO8pc = Duration.INSTANCE.m2381getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM2321plusLRDsOJo2 = Duration.m2321plusLRDsOJo(jM2383getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM2383getZEROUwyO8pc = Duration.m2321plusLRDsOJo(jM2321plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM2383getZEROUwyO8pc = Duration.m2321plusLRDsOJo(jM2383getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m2336unaryMinusUwyO8pc(jM2383getZEROUwyO8pc) : jM2383getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2292constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m2292constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m2292constructorimpl((j << 1) + ((long) i));
    }
