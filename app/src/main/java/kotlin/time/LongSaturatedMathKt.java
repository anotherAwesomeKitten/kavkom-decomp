...
public final class LongSaturatedMathKt {
    ...
    public static final long m2397saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM2331toLongimpl = Duration.m2331toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2396checkInfiniteSumDefinedPjuGub4(j, j2, jM2331toLongimpl);
        }
        if (((jM2331toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m2398saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM2331toLongimpl;
        return ((j ^ j3) & (jM2331toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* JADX INFO: renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m2396checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2317isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2398saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM2295divUwyO8pc = Duration.m2295divUwyO8pc(j2, 2);
        long jM2331toLongimpl = Duration.m2331toLongimpl(jM2295divUwyO8pc, durationUnit);
        return (1 | (jM2331toLongimpl - 1)) == Long.MAX_VALUE ? jM2331toLongimpl : m2397saturatingAddNuflL3o(m2397saturatingAddNuflL3o(j, durationUnit, jM2295divUwyO8pc), durationUnit, Duration.m2320minusLRDsOJo(j2, jM2295divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m2382getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m2381getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2336unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m2321plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m2336unaryMinusUwyO8pc(infinityOfSign(j3));
        }
