...
public final class UStringsKt {
    ...
    public static final String m2279toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2281toStringolVBNx4(short s, int i) {
    ...
    public static final String m2280toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2278toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1042constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m958boximpl(UByte.m964constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1042constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1222boximpl(UShort.m1228constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM1042constructorimpl = UInt.m1042constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM1042constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM1042constructorimpl2 = UInt.m1042constructorimpl(i3 * iM1042constructorimpl);
            int iM1042constructorimpl3 = UInt.m1042constructorimpl(UInt.m1042constructorimpl(iDigitOf) + iM1042constructorimpl2);
            if (Integer.compare(iM1042constructorimpl3 ^ Integer.MIN_VALUE, iM1042constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM1042constructorimpl3;
        }
        return UInt.m1036boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM1121constructorimpl = ULong.m1121constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM1121constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM1121constructorimpl2 = ULong.m1121constructorimpl(j * jM1121constructorimpl);
            long jM1121constructorimpl3 = ULong.m1121constructorimpl(ULong.m1121constructorimpl(((long) UInt.m1042constructorimpl(iDigitOf)) & 4294967295L) + jM1121constructorimpl2);
            if (Long.compare(jM1121constructorimpl3 ^ Long.MIN_VALUE, jM1121constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM1121constructorimpl3;
        }
        return ULong.m1115boximpl(j);
    }
}
