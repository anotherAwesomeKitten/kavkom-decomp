...
public class Base64 {
    ...
    public final int encodeIntoByteArray(byte[] source, byte[] bArr, int destinationOffset, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
    ...
    public final <A extends Appendable> A encodeToAppendable(byte[] source, A a, int startIndex, int endIndex) throws IOException {
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(a, "destination");
        a.append(new String(encodeToByteArrayImpl$kotlin_stdlib(source, startIndex, endIndex), Charsets.ISO_8859_1));
        return a;
    }
    ...
    public final int decodeIntoByteArray(byte[] source, byte[] bArr, int destinationOffset, int startIndex, int endIndex) {
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(bArr, "destination");
        checkSourceBounds$kotlin_stdlib(source.length, startIndex, endIndex);
        checkDestinationBounds(bArr.length, destinationOffset, decodeSize$kotlin_stdlib(source, startIndex, endIndex));
    ...
    public final int decodeIntoByteArray(CharSequence source, byte[] bArr, int destinationOffset, int startIndex, int endIndex) {
        byte[] bArrCharsToBytesImpl$kotlin_stdlib;
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(bArr, "destination");
        if (source instanceof String) {
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] bArr, int destinationOffset, int startIndex, int endIndex) {
        int i = startIndex;
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(bArr, "destination");
        checkSourceBounds$kotlin_stdlib(source.length, i, endIndex);
        checkDestinationBounds(bArr.length, destinationOffset, encodeSize$kotlin_stdlib(endIndex - i));
        ...
        if (i11 == 1) {
            ...
            bArr[i3] = bArr2[i18 >>> 12];
            bArr[i3 + 1] = bArr2[(i18 >>> 6) & 63];
            int i19 = i3 + 3;
            bArr[i3 + 2] = bArr2[i18 & 63];
            if (shouldPadOnEncode()) {
                i3 += 4;
                bArr[i19] = padSymbol;
            } else {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:94:0x00e9, code lost:
        ...
        if (r19.paddingOption == kotlin.io.encoding.Base64.PaddingOption.PRESENT) goto L96;
     */
