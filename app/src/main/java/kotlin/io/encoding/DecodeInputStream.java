...
final class DecodeInputStream extends InputStream {
    ...
    */
    ...
    private final void copyByteBufferInto(byte[] dst, int dstOffset, int i) {
        byte[] bArr = this.byteBuffer;
        int i2 = this.byteBufferStartIndex;
        ArraysKt.copyInto(bArr, dst, dstOffset, i2, i2 + i);
