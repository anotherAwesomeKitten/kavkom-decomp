...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m1115boximpl(m2190nextsVKNKU());
    }
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m1121constructorimpl(j3);
    ...
    public long m2190nextsVKNKU() {
        ...
        this.next = ULong.m1121constructorimpl(this.step + j);
        return j;
    }
}
