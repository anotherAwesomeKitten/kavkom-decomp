...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m1036boximpl(m2181nextpVg5ArA());
    }
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m1042constructorimpl(i3);
    ...
    public int m2181nextpVg5ArA() {
        ...
        this.next = UInt.m1042constructorimpl(this.step + i);
        return i;
    }
}
