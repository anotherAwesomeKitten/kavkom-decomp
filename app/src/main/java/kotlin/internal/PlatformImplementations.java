...
public class PlatformImplementations {
    ...
    public void addSuppressed(Throwable cause, Throwable th) throws IllegalAccessException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(cause, "cause");
        Intrinsics.checkNotNullParameter(th, "exception");
        Method method = ReflectThrowable.addSuppressed;
        if (method != null) {
            method.invoke(cause, th);
        }
    }
    ...
    public List<Throwable> getSuppressed(Throwable th) {
        ...
        return (method == null || (objInvoke = method.invoke(th, new Object[0])) == null || (listAsList = ArraysKt.asList((Throwable[]) objInvoke)) == null) ? CollectionsKt.emptyList() : listAsList;
    }
