...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m1115boximpl(ULong.m1121constructorimpl(getMostSignificantBits())), ULong.m1115boximpl(ULong.m1121constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m2431toUByteArrayTcUX1vc() {
        return UByteArray.m1018constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m1121constructorimpl(j) ^ Long.MIN_VALUE, ULong.m1121constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m1121constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m1121constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m2433fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m2432fromUByteArrayGBYM_sE(byte[] ubyteArray) {
