...
class AndroidVideoDecoder implements VideoDecoder, VideoSink {
    ...
    public VideoCodecStatus decode(EncodedImage encodedImage, VideoDecoder.DecodeInfo decodeInfo) {
        ...
        if (mediaCodecWrapper == null || this.callback == null) {
            Logging.d(TAG, "decode uninitalized, codec: " + (mediaCodecWrapper != null) + ", callback: " + this.callback);
    ...
    private void deliverByteFrame(int i, MediaCodec.BufferInfo bufferInfo, int i2, Integer num) throws Throwable {
        ...
        if (this.colorFormat == 19) {
            ...
            bufferCopyNV12ToI420Buffer = androidVideoDecoder.copyI420Buffer(byteBufferSlice, i7, i6, i3, i4);
        } else {
            androidVideoDecoder = this;
            bufferCopyNV12ToI420Buffer = androidVideoDecoder.copyNV12ToI420Buffer(byteBufferSlice, i7, i6, i3, i4);
        }
