...
class HardwareVideoEncoder implements VideoEncoder {
    ...
    private static class BusyCount {
        ...
        /* synthetic */ BusyCount(HardwareVideoEncoderIA hardwareVideoEncoderIA) {
            this();
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:76:0x00a2 A[Catch: IllegalArgumentException | IllegalStateException -> 0x0126, IllegalArgumentException -> 0x0128, TryCatch #3 {IllegalArgumentException | IllegalStateException -> 0x0126, blocks: (B:59:0x002d, B:61:0x0066, B:65:0x0075, B:76:0x00a2, B:70:0x0084, B:72:0x008c, B:73:0x009b, B:77:0x00b2, B:79:0x00bd, B:80:0x00c2, B:82:0x00c8, B:83:0x00cf, B:85:0x00e9, B:86:0x0105), top: B:98:0x002d }] */
    /*
    ...
    */
    ...
    public VideoCodecStatus release() {
        ...
        if (this.outputThread == null) {
            ...
            this.running = false;
            if (!ThreadUtils.joinUninterruptibly(this.outputThread, MetricsHelper.FLUSHER_SLEEP_TIME_MS)) {
    ...
    public VideoCodecStatus encode(VideoFrame videoFrame, VideoEncoder.EncodeInfo encodeInfo) {
        ...
        if (this.useSurfaceMode) {
            ...
            videoCodecStatusEncodeByteBuffer = encodeByteBuffer(videoFrame, j);
        }
    ...
    protected boolean isEncodingStatisticsSupported() {
        ...
        if (this.codecType == VideoCodecMimeType.VP8 || this.codecType == VideoCodecMimeType.VP9 || (codecInfo = this.codec.getCodecInfo()) == null || (capabilitiesForType = codecInfo.getCapabilitiesForType(this.codecType.mimeType())) == null) {
            return false;
        }
