...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static VideoFrame.Buffer cropAndScaleI420(final VideoFrame.I420Buffer i420Buffer, int i, int i2, int i3, int i4, int i5, int i6) {
        if (i3 == i5 && i4 == i6) {
            ...
            return wrap(i5, i6, byteBufferSlice, strideY, byteBufferSlice2, strideU, byteBufferSlice3, strideV, new Runnable() { // from class: org.webrtc.JavaI420Buffer$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    i420Buffer.release();
                }
