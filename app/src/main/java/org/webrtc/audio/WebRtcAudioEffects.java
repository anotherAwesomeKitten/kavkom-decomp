    ...
    public void enable(int i) {
        ...
        if (zIsAcousticEchoCancelerSupported) {
            ...
            if (acousticEchoCancelerCreate != null) {
                ...
                Logging.d(TAG, "AcousticEchoCanceler: was " + (enabled ? ViewProps.ENABLED : "disabled") + ", enable: " + z + ", is now: " + (this.aec.getEnabled() ? ViewProps.ENABLED : "disabled"));
            } else {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            if (noiseSuppressorCreate != null) {
                ...
                String str2 = enabled2 ? ViewProps.ENABLED : "disabled";
                if (!this.ns.getEnabled()) {
                    str = "disabled";
                }
                Logging.d(TAG, "NoiseSuppressor: was " + str2 + ", enable: " + z2 + ", is now: " + str);
                return;
            }
