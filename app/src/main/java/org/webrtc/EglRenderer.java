...
public class EglRenderer implements VideoSink {
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            ...
            this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$release$0(countDownLatch);
                }
            });
    ...
    public void addFrameListener(final FrameListener frameListener, final float f, final RendererCommon.GlDrawer glDrawer, final boolean z) {
        postToRenderThread(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$addFrameListener$1(glDrawer, frameListener, f, z);
            }
        });
    }
    ...
    public void removeFrameListener(final FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            ...
            postToRenderThread(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$removeFrameListener$2(countDownLatch, frameListener);
                }
            });
            ThreadUtils.awaitUninterruptibly(countDownLatch);
        }
    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        synchronized (this.threadLock) {
            ...
            synchronized (this.frameLock) {
                ...
                videoFrame.retain();
                this.eglThread.getHandler().post(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda5
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public void releaseEglSurface(final Runnable runnable) {
        ...
        synchronized (this.threadLock) {
            ...
            if (eglThread != null) {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f$0.lambda$releaseEglSurface$3(runnable);
                    }
                });
            } else {
                runnable.run();
    ...
    public void clearImage(final float f, final float f2, final float f3, final float f4) {
        synchronized (this.threadLock) {
            ...
            eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$clearImage$4(f, f2, f3, f4);
                }
            });
        }
    }
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            EglThread eglThread = this.eglThread;
            if (eglThread != null) {
                eglThread.scheduleRenderUpdate(new EglThread.RenderUpdate() { // from class: org.webrtc.EglRenderer$$ExternalSyntheticLambda3
                    @Override // org.webrtc.EglThread.RenderUpdate
                    public final void update(boolean z) {
                        this.f$0.lambda$swapBuffersOnRenderThread$5(videoFrame, j, z);
                    }
                });
            }
        }
