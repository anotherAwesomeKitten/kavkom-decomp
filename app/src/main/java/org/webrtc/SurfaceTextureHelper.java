...
public class SurfaceTextureHelper {
    ...
    /* synthetic */ SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, SurfaceTextureHelperIA surfaceTextureHelperIA) {
    ...
    public static SurfaceTextureHelper create(String str, EglBase.Context context, boolean z, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: org.webrtc.SurfaceTextureHelper.1
            ...
            AnonymousClass1(Handler handler2, boolean z2, YuvConverter yuvConverter2, FrameRefMonitor frameRefMonitor2, String str2) {
                handler = handler2;
                z = z2;
    ...
    class AnonymousClass1 implements Callable<SurfaceTextureHelper> {
        final /* synthetic */ boolean val$alignTimestamps;
        final /* synthetic */ FrameRefMonitor val$frameRefMonitor;
        final /* synthetic */ Handler val$handler;
        final /* synthetic */ String val$threadName;
    ...
    class AnonymousClass2 implements TextureBufferImpl.RefCountMonitor {
        AnonymousClass2() {
        }
