...
public class CameraEnumerationAndroid {
    static final ArrayList<Size> COMMON_RESOLUTIONS = new ArrayList<>(Arrays.asList(new Size(160, 120), new Size(240, 160), new Size(320, 240), new Size(400, 240), new Size(480, 320), new Size(640, 360), new Size(640, 480), new Size(ViewUtils.EDGE_TO_EDGE_FLAGS, 480), new Size(854, 480), new Size(800, TypedValues.Motion.TYPE_STAGGER), new Size(960, 540), new Size(960, 640), new Size(1024, 576), new Size(1024, TypedValues.Motion.TYPE_STAGGER), new Size(1280, 720), new Size(1280, 1024), new Size(1920, 1080), new Size(1920, 1440), new Size(2560, 1440), new Size(3840, 2160)));
